// Generated from ONNX "/var/home/holopengin/repos/InstantJPDictDecky/accessibility_daemon/assets/meiki.text.detect.v0.1.960x544.onnx" by burn-onnx
...
impl Submodule4 {
    ...
    pub fn forward(
        ...
        let shape8_out1: [i64; 3] = {
            let axes = &tile1_out1.clone().dims()[0..3];
            let mut output = [0i64; 3];
            for i in 0..3 {
                output[i] = axes[i] as i64;
            }
        ...
        let gather4_out1 = shape8_out1[2] as i64;
        let unsqueeze5_out1 = [gather4_out1 as i64];
        let concat16_out1: [i64; 3usize] = [
            ...
            .unwrap();
        let tile2_out1 = {
            let __repeats: alloc::vec::Vec<usize> = concat16_out1
                .iter()
                .map(|&v| v as usize)
                .collect();
            unsqueeze4_out1.clone().repeat(&__repeats)
        };
...
impl Submodule5 {
    ...
    pub fn forward(
    ...
    ) -> (Tensor<3>, [i64; 1], Tensor<2>, Tensor<4>, Tensor<4>, Tensor<4>, [i64; 3]) {
        ...
        let mul62_out1 = add35_out1
            .mul((constant351_out1).unsqueeze_dims(&[0isize, 1isize, 2isize, 3isize]));
        ...
        let mul63_out1 = gather6_out1 * gather7_out1;
        let unsqueeze8_out1 = [mul63_out1 as i64];
        let unsqueeze9_out1 = [gather8_out1 as i64];
        let constant385_out1: [i64; 1] = [68i64];
        let constant386_out1: [i64; 1] = [120i64];
        let concat18_out1: [i64; 4usize] = [
            ...
            .try_into()
            .unwrap();
        let reshape20_out1 = slice5_out1.reshape(concat18_out1);
        let gridsample1_out1 = reshape20_out1
            .clone()
            .grid_sample_2d(
                split5_out1,
        ...
        let constant387_out1: [i64; 1] = [34i64];
        let constant388_out1: [i64; 1] = [60i64];
        let concat19_out1: [i64; 4usize] = [
            ...
            .try_into()
            .unwrap();
        let reshape21_out1 = slice6_out1.reshape(concat19_out1);
        let gridsample2_out1 = reshape21_out1
            .clone()
            .grid_sample_2d(
                split5_out2,
                burn::tensor::ops::GridSampleOptions::new(
        ...
        let constant376_out1: [i64; 1] = [17i64];
        let constant377_out1: [i64; 1] = [30i64];
        let concat20_out1: [i64; 4usize] = [
            ...
            .try_into()
            .unwrap();
        let reshape22_out1 = slice7_out1.reshape(concat20_out1);
        let gridsample3_out1 = reshape22_out1
            .clone()
            .grid_sample_2d(
                split5_out3,
                burn::tensor::ops::GridSampleOptions::new(
...
impl Submodule6 {
    ...
    pub fn forward(
        ...
        constant355_out1: Tensor<1>,
        reshape20_out1: Tensor<4>,
        reshape21_out1: Tensor<4>,
        reshape22_out1: Tensor<4>,
        concat22_out1: [i64; 3],
    ) -> (
        Tensor<3>,
        Tensor<1>,
        ...
        let gridsample4_out1 = reshape20_out1
            .grid_sample_2d(
                split7_out1,
                burn::tensor::ops::GridSampleOptions::new(
                        burn::tensor::ops::InterpolateMode::Bilinear,
        ...
        let gridsample5_out1 = reshape21_out1
            .grid_sample_2d(
                split7_out2,
                burn::tensor::ops::GridSampleOptions::new(
                        burn::tensor::ops::InterpolateMode::Bilinear,
        ...
        let gridsample6_out1 = reshape22_out1
            .grid_sample_2d(
                split7_out3,
                burn::tensor::ops::GridSampleOptions::new(
                        burn::tensor::ops::InterpolateMode::Bilinear,
...
impl Submodule7 {
    ...
    pub fn forward(
        ...
        let gridsample7_out1 = reshape20_out1
            .grid_sample_2d(
                split9_out1,
                burn::tensor::ops::GridSampleOptions::new(
                        burn::tensor::ops::InterpolateMode::Bilinear,
        ...
        let gridsample8_out1 = reshape21_out1
            .grid_sample_2d(
                split9_out2,
                burn::tensor::ops::GridSampleOptions::new(
                        burn::tensor::ops::InterpolateMode::Bilinear,
        ...
        let gridsample9_out1 = reshape22_out1
            .grid_sample_2d(
                split9_out3,
                burn::tensor::ops::GridSampleOptions::new(
                        burn::tensor::ops::InterpolateMode::Bilinear,
...
impl Default for Model {
    fn default() -> Self {
        Self::from_file(
            "/var/home/holopengin/repos/InstantJPDictDecky/accessibility_daemon/burn_model_out_no_simplify_no_partition/meiki.text.detect.v0.1.bpk",
            &Default::default(),
        )
    }
}
    ...
    pub fn forward(
        ...
        let (
            ...
            .forward(
                ...
                constant355_out1.clone(),
                reshape20_out1.clone(),
                reshape21_out1.clone(),
                reshape22_out1.clone(),
                concat22_out1.clone(),
            );
        let (
            mul103_out1,
